...
const EN: MapT = {
  ...
  search: {
    ...
    ph3: 'A stop, address or place', ph4: 'Search in Grand Geneva',
    recent: 'Recent',
  },
  compact: {
    alertPrefix: 'Grand Geneva · ', alertSuffixS: 'alert ⚠️', alertSuffixP: 'alerts ⚠️',
    all: 'All · Traffic · Borders · Alerts',
    transit: 'Public Transport · TPG · CFF · CEVA',
    traffic: 'Road Traffic · Grand Geneva',
    alertsFilter: 'Alerts & Road Incidents',
    borders: 'Borders · 47 crossings',
    g7: 'G7 · 8–18 June 2026 · Évian',
    journey: 'My Trip · Favourites · Email Alerts',
    parkingFilter: 'P+R Car Parks · Grand Geneva',
    default: 'Grand Geneva',
  },
  ...
  alertsSection: {
    ...
    incidents: 'Incidents · Accidents · Works · Grand Geneva',
    noAlertTitle: 'No alerts detected',
    noAlertSub: 'Grand Geneva · Traffic normal right now',
    noIncidentTitle: 'No active incident',
    noIncidentSub: 'Grand Geneva · Traffic normal',
    sources: 'Sources',
  ...
  weather: {
    header: 'Weather · Grand Geneva · 24h', next4h: 'Next 4h',
  ...
  overview: {
    ...
    borjaDesc: 'This app was designed by our engineering team to help Grand Geneva residents travel smoothly during the G7 Évian 2026 — borders, traffic, public transport and real-time alerts, all in one place.',
  ...
  welcome: {
    ...
    feat2L: 'Traffic & works',   feat2D: 'Live heatmap + OSM roadworks',
...
const DE: MapT = {
  ...
  compact: {
    alertPrefix: 'Genf · ', alertSuffixS: 'Warnung ⚠️', alertSuffixP: 'Warnungen ⚠️',
  ...
  welcome: {
    ...
    feat4L: 'Offiz. Warnungen',     feat4D: 'Wetter + G7-Vorfälle',
...
const IT: MapT = {
  ...
  alertsSection: {
    ...
    incidents: 'Incidenti · Cantieri · Lavori · Grande Ginevra',
  ...
  banner: {
    ...
    activeBody: 'Orario estivo in vigore sulla maggior parte delle linee TPG.',
...
const ES: MapT = {
  ...
  welcome: {
    ...
    featBtn: '¡Empezamos! →',
    newBadge: 'NUEVO',
    feat1L: 'Fronteras G7',        feat1D: '47 puestos de control con estado live',
...
const JA: MapT = {
  ...
  search: {
    ph1: 'どこへ行きますか？', ph2: 'バルドネ、コルナヴァン、リーヴ...',
  ...
  parkingSection: {
    ...
    rtTitle: '表示中の総収容台数',
    rtSubPart: 'P+RはgeneneParking.chでリアルタイム情報を提供しています',
    source: '情報源', plAbbr: '台',
  },
  weather: {
...
const ZH: MapT = {
  ...
  weather: {
    ...
    showers: '阵雨', snowShowers: '阵雪', storm: '暴风雨',
  },
  journey: {
    header: '收藏路线 · 邮件提醒',
    addBtn: '+ 添加',
