...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'landecy', name: 'Landecy', lat: 46.14550, lng: 6.11720, type: 'tertiary', capacity: 'low', hours: 'Restreint (locaux)', vehicles: ['Voitures', 'Riverains'], pedestrian: false, g7Info: '🔒 Macaron requis · Ouvert 06:00–09:30 / 15:30–19:00 · Hors macaron : fermé · 12-18 juin (source : ge.ch)', nearestOpen: 'Bardonnex (6 km)' },
  ...
  { id: 'douvaine', name: 'Douvaine', lat: 46.31400, lng: 6.31700, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Camions'], pedestrian: false, g7Info: '✓ Ouvert · Hors canton GE — restrictions GE ne s\'appliquent pas · Contrôles renforcés G7 · Axe Annemasse ↔ Thonon', nearestOpen: undefined },
  ...
  { id: 'saint-julien', name: 'Saint-Julien-en-Genevois', lat: 46.12900, lng: 6.08100, type: 'main', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Cars', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026 · Hors périmètre des 7 passages autorisés GE · Axe A41 vers Annecy (source : ge.ch)', nearestOpen: 'Bardonnex (7 km)' },
