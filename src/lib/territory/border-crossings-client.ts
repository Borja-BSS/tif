...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'meyrin', name: 'Meyrin', lat: 46.23440, lng: 6.06100, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert 24/7 · Corridor CERN maintenu', nearestOpen: undefined },
  ...
  { id: 'divonne', name: 'Divonne-les-Bains', lat: 46.34574, lng: 6.15228, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Piétons'], pedestrian: true, g7Info: '✓ Ouvert 24/7 · Accès lac et casino', nearestOpen: undefined },
  ...
  { id: 'evian', name: 'Évian-les-Bains', lat: 46.40165, lng: 6.59477, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '🏛️ SITE G7 · Contrôles maximaux 8-18 juin · Accès très restreint sans accréditation', nearestOpen: 'Thonon (15 km)' },

  // ── NOUVEAU — Zone Annecy / Sud Haute-Savoie ────────────────────────────────
  { id: 'annemasse-gaillard', name: 'Annemasse / Gaillard', lat: 46.19520, lng: 6.23850, type: 'main', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos', 'Piétons', 'Tram'], pedestrian: true, g7Info: '✓ Ouvert · Axe principal Genève ↔ Annecy · Contrôles renforcés G7', nearestOpen: undefined },
  { id: 'saint-julien', name: 'Saint-Julien-en-Genevois', lat: 46.12900, lng: 6.08100, type: 'main', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Cars', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert 24/7 · Axe A41 vers Annecy · Renforcé G7', nearestOpen: undefined },
