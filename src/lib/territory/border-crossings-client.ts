...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'mategnin', name: 'Mategnin', lat: 46.232, lng: 6.0688, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Meyrin (3 km)' },
  ...
  { id: 'hermance', name: 'Hermance', lat: 46.3018, lng: 6.2439, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Piétons', 'Vélos'], pedestrian: true, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Veigy (8 km)' },
  ...
  { id: 'landecy', name: 'Landecy', lat: 46.1409, lng: 6.072, type: 'tertiary', capacity: 'low', hours: 'Restreint (locaux)', vehicles: ['Voitures', 'Riverains'], pedestrian: false, g7Info: '🔒 Macaron requis · Ouvert 06:00–09:30 / 15:30–19:00 · Hors macaron : fermé · 12-18 juin (source : ge.ch)', nearestOpen: 'Bardonnex (6 km)' },
  ...
  { id: 'veigy', name: 'Veigy', lat: 46.2492, lng: 6.2571, type: 'tertiary', capacity: 'low', hours: 'Restreint (locaux)', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Anières (5 km)' },
  ...
  { id: 'saint-cergue', name: 'Saint-Cergue (Col de la Givrine)', lat: 46.441, lng: 6.109, type: 'secondary', capacity: 'low', hours: '24h/24 (saison)', vehicles: ['Voitures', 'Motos', 'Vélos', 'Piétons'], pedestrian: true, g7Info: '✓ Ouvert · Passage Nyon ↔ Morez FR', nearestOpen: 'La Cure (15 km)' },
  { id: 'vallorbe', name: 'Vallorbe', lat: 46.714, lng: 6.37, type: 'main', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Train', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · Douane principale Vaud · Ligne CFF Lausanne-Paris', nearestOpen: undefined },
