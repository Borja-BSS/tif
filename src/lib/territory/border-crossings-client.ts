...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'thonex-vallard', name: 'Thônex-Vallard', lat: 46.1965, lng: 6.2082, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '⭐ Poste macaron prioritaire · Accès prioritaire réservé au personnel essentiel des services critiques · Douanes secondaires ouvertes sur plages horaires dédiées · Pièce d\'identité obligatoire · Contrôles systématiques 12–18 juin · Des temps d\'attente sont à prévoir', nearestOpen: undefined },
  { id: 'moillesulaz', name: 'Moillesulaz', lat: 46.1912, lng: 6.1995, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Piétons', 'Vélos', 'Tram D'], pedestrian: true, g7Info: '✓ Ouvert 24/7 pendant le G7 · Pièce d\'identité obligatoire · Contrôles renforcés · Des temps d\'attente sont à prévoir', nearestOpen: undefined },
  { id: 'meyrin', name: 'Meyrin', lat: 46.2336, lng: 6.0545, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert 24/7 pendant le G7 · Pièce d\'identité obligatoire · Contrôles systématiques · Corridor CERN maintenu', nearestOpen: undefined },
  ...
  { id: 'fossard', name: 'Fossard', lat: 46.1948, lng: 6.2052, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Moillesulaz (1 km)' },
  ...
  { id: 'mon-idee', name: 'Mon-Idée', lat: 46.1565, lng: 6.0975, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Perly (1 km)' },
  { id: 'monniaz', name: 'Monniaz', lat: 46.2432, lng: 6.2468, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Macaron requis · Ouvert 06:00–09:30 / 15:30–19:00 · Hors macaron : fermé · 12-18 juin (source : ge.ch)', nearestOpen: 'Anières (3 km)' },
  { id: 'chancy', name: 'Chancy', lat: 46.14442, lng: 5.96583, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Macaron requis · Ouvert 06:00–09:30 / 15:30–19:00 · Hors macaron : fermé · 12-18 juin (source : ge.ch)', nearestOpen: 'Soral (14 km)' },
  ...
  { id: 'soral', name: 'Soral', lat: 46.13712, lng: 6.03616, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Bardonnex (18 km)' },
  ...
  { id: 'compesieres', name: 'Compesières', lat: 46.14950, lng: 6.07338, type: 'tertiary', capacity: 'low', hours: '06:00–18:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Perly (2 km)' },
  ...
  { id: 'ecogia', name: 'Écogia (Satigny)', lat: 46.23400, lng: 6.00800, type: 'tertiary', capacity: 'low', hours: 'Restreint (agricole)', vehicles: ['Voitures', 'Tracteurs'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Meyrin (8 km)' },
  ...
  { id: 'prevessin-moens', name: 'Prévessin-Moëns', lat: 46.25000, lng: 6.04850, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · Zone CERN · Contrôles fréquents', nearestOpen: undefined },
  { id: 'sauverny', name: 'Sauverny', lat: 46.31135, lng: 6.12051, type: 'secondary', capacity: 'low', hours: '06:00–22:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '⚠️ Contrôles renforcés pendant G7', nearestOpen: 'Ferney-Voltaire (7 km)' },
  { id: 'thoiry', name: 'Thoiry / Saint-Jean-de-Gonville', lat: 46.25000, lng: 5.98850, type: 'secondary', capacity: 'low', hours: '06:00–22:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '⚠️ Contrôles renforcés pendant G7', nearestOpen: 'La Plaine (12 km)' },
  { id: 'peron', name: 'Péron', lat: 46.17900, lng: 5.91050, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '⚠️ Contrôles renforcés pendant G7', nearestOpen: 'La Plaine (15 km)' },
  ...
  { id: 'saint-cergue', name: 'Saint-Cergue (Col de la Givrine)', lat: 46.4200, lng: 6.0820, type: 'secondary', capacity: 'low', hours: '24h/24 (saison)', vehicles: ['Voitures', 'Motos', 'Vélos', 'Piétons'], pedestrian: true, g7Info: '✓ Ouvert · Passage Nyon ↔ Morez FR', nearestOpen: 'La Cure (15 km)' },
  { id: 'vallorbe', name: 'Vallorbe', lat: 46.7282, lng: 6.4018, type: 'main', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Train', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · Douane principale Vaud · Ligne CFF Lausanne-Paris', nearestOpen: undefined },
  ...
  { id: 'collonges', name: 'Collonges-sous-Salève', lat: 46.13300, lng: 6.14900, type: 'secondary', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · A40 direction Annecy / Sallanches', nearestOpen: undefined },

  // ── NOUVEAU — Zone Jura / Pontarlier / Champagnole ──────────────────────────
  { id: 'les-hopitaux-neufs', name: 'Les Hôpitaux-Neufs / Pontarlier', lat: 46.7735, lng: 6.3715, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · Axe RN57 Pontarlier ↔ Vallorbe (CH)', nearestOpen: undefined },
  { id: 'saint-Laurent', name: 'Saint-Laurent-en-Grandvaux', lat: 46.5810, lng: 6.1150, type: 'secondary', capacity: 'low', hours: '06:00–22:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · Jura ↔ Vaud · Vers Champagnole', nearestOpen: 'La Cure (20 km)' },
...
const G7_OPEN  = new Set(['bardonnex','thonex-vallard','moillesulaz','meyrin','ferney-voltaire','perly','anieres','prevessin-moens','divonne','leaz','la-cure','vallorbe','bois-d-amont','les-hopitaux-neufs','saint-Laurent','douvaine','thonon','collonges','sauverny'])
