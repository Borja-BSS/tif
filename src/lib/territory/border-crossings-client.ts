...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'moillesulaz', name: 'Moillesulaz', lat: 46.1922, lng: 6.2063, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Piétons', 'Vélos', 'Tram D'], pedestrian: true, g7Info: '✓ Ouvert 24/7 pendant le G7 · Pièce d\'identité obligatoire · Contrôles renforcés · Des temps d\'attente sont à prévoir', nearestOpen: undefined },
