...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'cornavin-tgv', name: 'Cornavin — Douane TGV', lat: 46.2099487, lng: 6.1414634, type: 'rail', capacity: 'medium', hours: 'Selon horaires TGV Lyria', vehicles: ['TGV Lyria', 'Trains internationaux CFF'], pedestrian: true, g7Info: '✅ Accès autorisé sans macaron · Contrôle OFDF permanent 24h/24 à quai (source : ge.ch + OFDF officiel) · CH→FR : délais d\'attente importants avant embarquement — arrivez ~45 min avant le départ · FR→CH : contrôle PAF France à bord ou sur quai à l\'arrivée · Pièce d\'identité obligatoire · Horaires TGV Lyria Paris-Genève maintenus 12–18 juin (aucune modification CFF annoncée) · ⚠️ 10 juin grève SNCF : trains 9773 et 9776 supprimés', nearestOpen: undefined },

  // ── TIER 1 — Geneva canton, 24/7 ────────────────────────────────────────────
  { id: 'bardonnex', name: 'Bardonnex', lat: 46.14952, lng: 6.09693, type: 'motorway', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Cars', 'Motos'], pedestrian: false, g7Info: '⭐ Poste macaron prioritaire · Douane OUVERTE 24h/24 · ⚠️ A1 CH→FR fermée 15–17 juin (sortie obligatoire Meyrin/Vernier/Genève-Centre — source : ge.ch) · A1 FR→CH ouverte · Pièce d\'identité obligatoire · Contrôles systématiques · Des temps d\'attente sont à prévoir', nearestOpen: undefined },
  ...
  { id: 'moillesulaz', name: 'Moillesulaz', lat: 46.1922427, lng: 6.2064349, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Piétons', 'Vélos', 'Tram D'], pedestrian: true, g7Info: '✓ Ouvert 24/7 pendant le G7 · Pièce d\'identité obligatoire · Contrôles renforcés · Des temps d\'attente sont à prévoir', nearestOpen: undefined },
  { id: 'meyrin', name: 'Meyrin', lat: 46.2347, lng: 6.0505, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert 24/7 pendant le G7 · Pièce d\'identité obligatoire · Contrôles systématiques · Corridor CERN maintenu', nearestOpen: undefined },
  { id: 'ferney-voltaire', name: 'Ferney-Voltaire', lat: 46.25005, lng: 6.11905, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Cars'], pedestrian: false, g7Info: '✓ Ouvert 24/7 pendant le G7 · Pièce d\'identité obligatoire · Contrôles renforcés · Proximité aéroport GVA', nearestOpen: undefined },
  { id: 'perly', name: 'Perly', lat: 46.15234, lng: 6.09103, type: 'secondary', capacity: 'low', hours: '24h/24', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert 24/7 pendant le G7 · Pièce d\'identité obligatoire · Route de Saint-Julien-en-Genevois · Des temps d\'attente sont à prévoir', nearestOpen: undefined },
  { id: 'anieres', name: 'Anières', lat: 46.26932, lng: 6.23901, type: 'secondary', capacity: 'low', hours: '24h/24', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert 24/7 pendant le G7 · Pièce d\'identité obligatoire · Passage est du canton · Des temps d\'attente sont à prévoir', nearestOpen: undefined },
  ...
  { id: 'fossard', name: 'Fossard', lat: 46.1836465, lng: 6.1950107, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Moillesulaz (2 km)' },
  ...
  { id: 'avully', name: 'Avully', lat: 46.1618, lng: 5.9778, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Perly (9 km)' },
  { id: 'la-plaine', name: 'La Plaine', lat: 46.17737, lng: 5.99153, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Meyrin (20 km)' },
  { id: 'communaux-ambilly', name: 'Communaux d\'Ambilly', lat: 46.1982, lng: 6.2118, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Riverains'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Moillesulaz (2 km)' },
  { id: 'hermance', name: 'Hermance', lat: 46.30283, lng: 6.24758, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Piétons', 'Vélos'], pedestrian: true, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Veigy (8 km)' },
  { id: 'soral', name: 'Soral', lat: 46.1433, lng: 6.0451, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Perly (4 km)' },
  { id: 'mandement', name: 'Mandement (Satigny)', lat: 46.2018913, lng: 5.9718478, type: 'secondary', capacity: 'low', hours: '06:00–20:00 (hors G7)', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Meyrin (12 km)' },
  { id: 'dardagny', name: 'Dardagny', lat: 46.1900628, lng: 5.9820292, type: 'secondary', capacity: 'low', hours: '06:00–20:00 (hors G7)', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Meyrin (11 km)' },
  { id: 'valleiry', name: 'Valleiry', lat: 46.1336524, lng: 5.9774808, type: 'secondary', capacity: 'low', hours: '06:00–20:00 (hors G7)', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Perly (18 km) · Bardonnex (19 km)' },
  { id: 'avusy', name: 'Avusy', lat: 46.1427496, lng: 6.0088161, type: 'secondary', capacity: 'low', hours: '06:00–20:00 (hors G7)', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Perly (12 km) · Bardonnex (12 km)' },
  { id: 'avusy-sezegnin', name: 'Avusy Sézegnin', lat: 46.1427656, lng: 6.0087949, type: 'tertiary', capacity: 'low', hours: '06:00–20:00 (hors G7)', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Perly (12 km) · Bardonnex (12 km)' },
  { id: 'soral-mangons', name: 'Soral — Rte des Mangons', lat: 46.1426323, lng: 6.0470017, type: 'secondary', capacity: 'low', hours: '06:00–20:00 (hors G7)', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Perly (7 km) · Bardonnex (8 km)' },
  { id: 'pas-de-lechelle', name: 'Pas-de-l\'Échelle', lat: 46.1664299, lng: 6.1884322, type: 'secondary', capacity: 'low', hours: '06:00–20:00 (hors G7)', vehicles: ['Voitures', 'Motos', 'Piétons'], pedestrian: true, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Thônex-Vallard (4 km) · Moillesulaz (4 km)' },
  // ── TIER 3 — Geneva canton, tertiary ────────────────────────────────────────
  { id: 'landecy', name: 'Landecy', lat: 46.1430, lng: 6.1270, type: 'tertiary', capacity: 'low', hours: 'Restreint (locaux)', vehicles: ['Voitures', 'Riverains'], pedestrian: false, g7Info: '🔒 Macaron requis · Ouvert 06:00–09:30 / 15:30–19:00 · Hors macaron : fermé · 12-18 juin (source : ge.ch)', nearestOpen: 'Bardonnex (3 km)' },
  { id: 'bossey', name: 'Bossey', lat: 46.1548324, lng: 6.1608997, type: 'tertiary', capacity: 'low', hours: 'Piétons / Vélos uniquement', vehicles: ['Piétons', 'Vélos'], pedestrian: true, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Bardonnex (9 km) · Perly (8 km)' },
  { id: 'troinex', name: 'Troinex', lat: 46.1545, lng: 6.1613, type: 'tertiary', capacity: 'low', hours: 'Restreint (locaux)', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Veyrier (2 km)' },
  { id: 'compesieres', name: 'Compesières', lat: 46.1460, lng: 6.1195, type: 'tertiary', capacity: 'low', hours: '06:00–18:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Bardonnex (2 km)' },
  { id: 'bernex', name: 'Bernex', lat: 46.15500, lng: 6.04050, type: 'tertiary', capacity: 'low', hours: 'Restreint (locaux)', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Perly (4 km)' },
  { id: 'ecogia', name: 'Écogia (Satigny)', lat: 46.2350, lng: 6.0278, type: 'tertiary', capacity: 'low', hours: 'Restreint (agricole)', vehicles: ['Voitures', 'Tracteurs'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Meyrin (6 km)' },
  ...
  { id: 'sauverny', name: 'Sauverny', lat: 46.3114, lng: 6.1204, type: 'secondary', capacity: 'low', hours: '06:00–22:00 (hors G7)', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Meyrin (5 km) · Ferney-Voltaire (7 km)' },
  { id: 'bois-chaton', name: 'Bois-Châton', lat: 46.2869728, lng: 6.1045552, type: 'secondary', capacity: 'low', hours: '06:00–22:00 (hors G7)', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Meyrin (4 km)' },
  { id: 'versoix-ferney', name: 'Versoix / Ferney', lat: 46.2608456, lng: 6.1197727, type: 'secondary', capacity: 'low', hours: '06:00–22:00 (hors G7)', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé du 12 au 18 juin 2026', nearestOpen: 'Ferney-Voltaire (1 km) · Meyrin (5 km)' },
  ...
  { id: 'sciez', name: 'Sciez / Ballaison', lat: 46.34158, lng: 6.39015, type: 'secondary', capacity: 'low', hours: '06:00–22:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '⚠️ Contrôles pendant G7', nearestOpen: 'Douvaine (8 km)' },
  { id: 'excenevex', name: 'Excenevex / Yvoire', lat: 46.37162, lng: 6.32362, type: 'tertiary', capacity: 'low', hours: 'Piétons / Vélos / Riverains', vehicles: ['Piétons', 'Vélos', 'Voitures riverains'], pedestrian: true, g7Info: '⚠️ Contrôles renforcés G7 · Rive lac Léman', nearestOpen: 'Douvaine (9 km)' },
  ...
  { id: 'evian', name: 'Évian-les-Bains', lat: 46.40163, lng: 6.59467, type: 'main', capacity: 'medium', hours: 'PASS G7 requis', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '🏛️ SITE G7 · Zone bleue active 11-17 juin · PASS G7 (QR code) obligatoire · Bac CGN suspendu — relocalisé à Thonon et Lugrin · Accès très restreint (source : haute-savoie.gouv.fr)', nearestOpen: 'Thonon (15 km)' },
