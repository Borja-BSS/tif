...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'sauverny', name: 'Sauverny', lat: 46.28694, lng: 6.10450, type: 'secondary', capacity: 'low', hours: '06:00–22:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '⚠️ Contrôles renforcés pendant G7', nearestOpen: 'Meyrin (5 km)' },
