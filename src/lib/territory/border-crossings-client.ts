...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'divonne', name: 'Divonne-les-Bains', lat: 46.35820, lng: 6.14800, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Piétons'], pedestrian: true, g7Info: '✓ Ouvert 24/7 · Accès lac et casino', nearestOpen: undefined },
