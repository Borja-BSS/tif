...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'bardonnex', name: 'Bardonnex', lat: 46.14856, lng: 6.09561, type: 'motorway', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Cars', 'Motos'], pedestrian: false, g7Info: '⭐ Poste macaron prioritaire G7 · Contrôle permanent OFDF 24h/24 · 12-18 juin (source : ge.ch)', nearestOpen: undefined },
  { id: 'thonex-vallard', name: 'Thônex-Vallard', lat: 46.18885, lng: 6.20215, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '⭐ Poste macaron prioritaire G7 · Contrôle permanent OFDF 24h/24 · 12-18 juin (source : ge.ch)', nearestOpen: undefined },
  { id: 'moillesulaz', name: 'Moillesulaz', lat: 46.19220, lng: 6.20628, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Piétons', 'Vélos', 'Tram D'], pedestrian: true, g7Info: '✓ Ouvert 24h/24 · Contrôle permanent OFDF · 12-18 juin (source : ge.ch)', nearestOpen: undefined },
  ...
  { id: 'ferney-voltaire', name: 'Ferney-Voltaire', lat: 46.25004, lng: 6.11905, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Cars'], pedestrian: false, g7Info: '✓ Ouvert 24h/24 · Contrôle permanent OFDF · Proximité aéroport GVA · 12-18 juin (source : ge.ch)', nearestOpen: undefined },
  { id: 'perly', name: 'Perly', lat: 46.15199, lng: 6.09056, type: 'secondary', capacity: 'low', hours: '24h/24', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert 24h/24 · Contrôle permanent OFDF · Route de Saint-Julien · 12-18 juin (source : ge.ch)', nearestOpen: undefined },
  { id: 'anieres', name: 'Anières', lat: 46.26925, lng: 6.23907, type: 'secondary', capacity: 'low', hours: '24h/24', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert 24h/24 · Contrôle permanent OFDF · Passage est · 12-18 juin (source : ge.ch)', nearestOpen: undefined },
  ...
  { id: 'mon-idee', name: 'Mon-Idée', lat: 46.14500, lng: 6.07600, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Perly (1 km)' },
  ...
  { id: 'chancy', name: 'Chancy', lat: 46.14442, lng: 5.96568, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '🔒 Macaron requis · Ouvert 06:00–09:30 / 15:30–19:00 · Hors macaron : fermé · 12-18 juin (source : ge.ch)', nearestOpen: 'Soral (14 km)' },
  ...
  { id: 'communaux-ambilly', name: 'Communaux d\'Ambilly', lat: 46.19480, lng: 6.23270, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures', 'Riverains'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Moillesulaz (2 km)' },
  ...
  { id: 'landecy', name: 'Landecy', lat: 46.14464, lng: 6.12951, type: 'tertiary', capacity: 'low', hours: 'Restreint (locaux)', vehicles: ['Voitures', 'Riverains'], pedestrian: false, g7Info: '🔒 Macaron requis · Ouvert 06:00–09:30 / 15:30–19:00 · Hors macaron : fermé · 12-18 juin (source : ge.ch)', nearestOpen: 'Bardonnex (6 km)' },
  ...
  { id: 'troinex', name: 'Troinex', lat: 46.16165, lng: 6.14782, type: 'tertiary', capacity: 'low', hours: 'Restreint (locaux)', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Veyrier (2 km)' },
  ...
  { id: 'divonne', name: 'Divonne-les-Bains', lat: 46.34574, lng: 6.15228, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Piétons'], pedestrian: true, g7Info: '✓ Ouvert 24h/24 · Canton Vaud — pas de fermeture G7 · Contrôles renforcés possibles · Accès lac et casino (source : admin.ch)', nearestOpen: undefined },
  ...
  { id: 'saint-cergue', name: 'Saint-Cergue (Col de la Givrine)', lat: 46.45460, lng: 6.08771, type: 'secondary', capacity: 'low', hours: '24h/24 (saison)', vehicles: ['Voitures', 'Motos', 'Vélos', 'Piétons'], pedestrian: true, g7Info: '✓ Ouvert · Passage Nyon ↔ Morez FR', nearestOpen: 'La Cure (15 km)' },
  { id: 'vallorbe', name: 'Vallorbe', lat: 46.73154, lng: 6.38525, type: 'main', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Train', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · Douane principale Vaud · Ligne CFF Lausanne-Paris', nearestOpen: undefined },

  // ── NOUVEAU — Haute-Savoie (vers Thonon/Évian) ──────────────────────────────
  { id: 'douvaine', name: 'Douvaine', lat: 46.30598, lng: 6.30250, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Camions'], pedestrian: false, g7Info: '✓ Ouvert · Hors canton GE — restrictions GE ne s\'appliquent pas · Contrôles renforcés G7 · Axe Annemasse ↔ Thonon', nearestOpen: undefined },
  ...
  { id: 'thonon', name: 'Thonon-les-Bains', lat: 46.37100, lng: 6.47700, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · Hors canton GE · CGN relocalisé ici (bac Évian suspendu) · Axe vers Valais · Renforcé G7 (source : thononagglo.fr)', nearestOpen: undefined },
  { id: 'evian', name: 'Évian-les-Bains', lat: 46.40165, lng: 6.59477, type: 'main', capacity: 'medium', hours: 'PASS G7 requis', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '🏛️ SITE G7 · Zone bleue active 11-17 juin · PASS G7 (QR code) obligatoire · Bac CGN suspendu — relocalisé à Thonon et Lugrin · Accès très restreint (source : haute-savoie.gouv.fr)', nearestOpen: 'Thonon (15 km)' },

  // ── NOUVEAU — Zone Annecy / Sud Haute-Savoie ────────────────────────────────
  { id: 'annemasse-gaillard', name: 'Annemasse / Gaillard', lat: 46.19520, lng: 6.23850, type: 'main', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos', 'Piétons', 'Tram'], pedestrian: true, g7Info: '⚠️ Passage routier fermé 12-18 juin · Gare d\'Annemasse autorisée (Léman Express) · (source : ge.ch)', nearestOpen: 'Moillesulaz (2 km)' },
  { id: 'saint-julien', name: 'Saint-Julien-en-Genevois', lat: 46.14448, lng: 6.08125, type: 'main', capacity: 'high', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Cars', 'Motos'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026 · Hors périmètre des 7 passages autorisés GE · Axe A41 vers Annecy (source : ge.ch)', nearestOpen: 'Bardonnex (7 km)' },
  ...
  { id: 'les-hopitaux-neufs', name: 'Les Hôpitaux-Neufs / Pontarlier', lat: 46.90073, lng: 6.45820, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · Axe RN57 Pontarlier ↔ Vallorbe (CH)', nearestOpen: undefined },
  ...
  { id: 'bois-d-amont', name: 'Bois-d\'Amont (Jura)', lat: 46.54842, lng: 6.15902, type: 'secondary', capacity: 'low', hours: '24h/24 (saison ski)', vehicles: ['Voitures', 'Motos', 'Piétons'], pedestrian: true, g7Info: '✓ Ouvert · Station Les Rousses ↔ Suisse · Zone ski transfrontalière', nearestOpen: 'La Cure (5 km)' },
]
