...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'bossey', name: 'Bossey', lat: 46.1543, lng: 6.1611, type: 'tertiary', capacity: 'low', hours: 'Piétons / Vélos uniquement', vehicles: ['Piétons', 'Vélos'], pedestrian: true, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Veyrier (3 km)' },
