...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'thonex-vallard', name: 'Thônex-Vallard', lat: 46.1889, lng: 6.2021, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '⭐ Poste macaron prioritaire G7 · Contrôle permanent OFDF 24h/24 · 12-18 juin (source : ge.ch)', nearestOpen: undefined },
  { id: 'moillesulaz', name: 'Moillesulaz', lat: 46.1922, lng: 6.2063, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos', 'Piétons', 'Vélos', 'Tram D'], pedestrian: true, g7Info: '✓ Ouvert 24h/24 · Contrôle permanent OFDF · 12-18 juin (source : ge.ch)', nearestOpen: undefined },
  ...
  { id: 'mon-idee', name: 'Mon-Idée', lat: 46.20654, lng: 6.25008, type: 'secondary', capacity: 'low', hours: '06:00–20:00', vehicles: ['Voitures'], pedestrian: false, g7Info: '🔒 Fermé 12-18 juin 2026', nearestOpen: 'Perly (1 km)' },
