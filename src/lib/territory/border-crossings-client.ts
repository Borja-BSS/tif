...
export const ALL_CROSSINGS: CrossingStatic[] = [
  ...
  { id: 'thonex-vallard', name: 'Thônex-Vallard', lat: 46.1889, lng: 6.2021, type: 'main', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Camions', 'Motos'], pedestrian: false, g7Info: '⭐ Poste macaron prioritaire · Accès prioritaire réservé au personnel essentiel des services critiques · Douanes secondaires ouvertes sur plages horaires dédiées · Pièce d\'identité obligatoire · Contrôles systématiques 12–18 juin · Des temps d\'attente sont à prévoir', nearestOpen: undefined },
  ...
  { id: 'collonges', name: 'Collonges-sous-Salève', lat: 46.1400, lng: 6.1490, type: 'secondary', capacity: 'medium', hours: '24h/24', vehicles: ['Voitures', 'Motos'], pedestrian: false, g7Info: '✓ Ouvert · A40 direction Annecy / Sallanches', nearestOpen: undefined },
