...
const SPRING    = 'height 0.22s cubic-bezier(0.22, 0.61, 0.36, 1)'
// Transition douce pour les repositionnements libres
const EASE      = 'height 0.14s cubic-bezier(0.22, 0.61, 0.36, 1)'
    ...
    <div className="space-y-3">
      ...
      <div className="pt-1">
        ...
        {selectedLine && !selectedStop && (() => {
          ...
          return (
            <div key={selectedLine} className="rounded-2xl overflow-hidden" style={{ border: `1px solid ${c}30`, animation: 'fadeUp 0.12s cubic-bezier(0.22, 0.61, 0.36, 1)' }}>
              {/* Header */}
        ...
        {selectedStop && (
          <div key={`${selectedStop.name}|${selectedStop.line}`} style={{ animation: 'fadeUp 0.12s cubic-bezier(0.22, 0.61, 0.36, 1)' }}>
            <StopDeparturesPanel
    ...
    <div className="space-y-3">
      ...
      {showBanner && (
        <div className="flex items-center gap-3 rounded-2xl px-4 py-3"
          style={{ background: 'rgba(52,199,89,0.12)', border: '0.5px solid rgba(52,199,89,0.40)', backdropFilter: 'blur(20px)', animation: 'slideDown 0.14s cubic-bezier(0.22, 0.61, 0.36, 1) forwards' }}>
    ...
    >
      ...
      <div ref={contentRef} className="flex-1 overflow-y-auto px-4 pb-6" style={{ WebkitOverflowScrolling: 'touch' } as React.CSSProperties}>
        <div key={`${detailView}|${selectedCrossing?.id ?? ''}|${selectedAlertItem?.id ?? ''}|${selectedEvent ?? ''}|${selectedImpactZone?.id ?? ''}`}
             style={{ animation: 'fadeUp 0.12s cubic-bezier(0.22, 0.61, 0.36, 1)' }}>
